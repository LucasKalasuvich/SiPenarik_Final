@extends('layouts.app')
@section('title', 'Permintaan Tanda Tangan')
@section('styles')
...
<div class="section_our_solution mt-2 ">
  <div class="row">
    <div class="col-xl-12">
      <div class="mt-1">
        <h3 class="p-2">Requested File</h3>
      </div>
      ...
      <div class="card-body shadow" style="display: flex">
              ...
              <tr>
                ...
                <td>
                  <object data="{{$data['file']}}" type="application/pdf" width="100%" height="100%">
                    <p><a style="text-decoration: none; color:blue" href="/appOrdecSign/{{encrypt($data->id)}}">{{$data->file->file}}</a></p>
                  </object>
                  @if($data->status == 'Waiting')

                    <small style="color:orange">
                      Requested By {{$data->users->nama}}
                    </small>
                  @endif
